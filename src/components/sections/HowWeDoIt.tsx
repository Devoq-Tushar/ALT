...
const data: dataType[] = [
    {
        ...
        image: "/assets/images/how-we-do-it-img-1.svg",
    },
    {
        id: 2,
        ...
        image: "/assets/images/how-we-do-it-img-2.svg",
    },
    {
        id: 3,
        ...
        image: "/assets/images/how-we-do-it-img-3.svg",
    },
];
        ...
        <div className="relative overflow-hidden">
            <div className="relative flex flex-col justify-center items-center gap-6 sm:gap-12 container w-full p-6 sm:py-[100px] sm:pt-0 rounded-2xl z-10">
                ...
                <div className="content-stretch flex gap-5 flex-wrap flex-row md:gap-6 lg:gap-[30px] items-center justify-center relative shrink-0 w-full">
                    {data.map((data, index) => (
                        <div key={index} className="bg-white relative rounded-xl md:rounded-[20px] shrink-0 w-full md:max-w-[370px] border-2 md:border-4 border-bg-secondary/10 ">
                            <div className="box-border content-stretch flex flex-col gap-4 md:gap-6 items-center overflow-clip pb-4 md:pb-6 pt-0 px-4 md:px-6 relative rounded-[inherit] w-full">
                                ...
                                <div className="h-[250px] md:h-[286px] relative shrink-0 w-full">
                                    <div className="absolute inset-0 overflow-hidden pointer-events-none">
                                        <img alt="" className="absolute h-[124.75%] left-[-3.48%] max-w-none top-[-9.58%] w-[106.96%]" src={data.image} />
                                    </div>
                                </div>
