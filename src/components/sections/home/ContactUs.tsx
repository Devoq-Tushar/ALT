        ...
        <div className="relative overflow-hidden bg-[#5172E7]">
            <div className="relative flex flex-col justify-center items-center gap-8 sm:gap-10 container w-full px-6 py-8 md:py-[120px] rounded-2xl z-10">
                <div className="flex flex-col justify-center items-center gap-3 md:gap-4">
                    <span className="text-text-white font-bold text-[25px] sm:text-[44px] leading-normal md:leading-[57px]">Let’s get started with ALT</span>
                ...
                <button className="bg-bg-white box-border flex gap-4 items-center justify-center px-4 py-2.5 md:px-6 md:py-4 relative rounded-xl w-fit transition-all duration-300 ease-out
    hover:scale-[1.04] hover:shadow-lg cursor-pointer shadow-[0px_2px_18px_0px_rgba(0,0,0,0.25)]">
                    <span className="leading-6 relative text-sm sm:text-base text-nowrap text-[#5172E7] whitespace-pre font-semibold">
                        Sign Up
                    </span>
                </button>
            </div>
