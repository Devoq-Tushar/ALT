...
const Features: React.FC = () => {
    ...
    return (
        <section
            id="why-alt"
            className="relative w-full flex flex-col py-[120px] bg-white bg-[url('/assets/landing/bg-circle.svg')] gap-8 md:gap-8 bg-no-repeat bg-position-[110%_center]
      max-[991px]:p-6 max-[991px]:py-8"
        >
            <div className='absolute md:right-[-68px] md:top-9 right-[-190px] top-[100px] w-auto md:h-auto h-[327px]'>
                <img src="assets/images/bg-element-img.png" alt="" className='w-full h-full' />
            </div>
            {/* HEADER */}
            <div className="max-w-[1170px] mx-auto px-4 relative z-1">
            ...
            {/* FEATURES */}
            <div className="max-w-[1170px] mx-auto flex gap-4 md:gap-[25px] items-start max-[1199px]:flex-wrap relative z-1">
                {/* LEFT */}
                <div className="w-1/2 max-[1199px]:w-full bg-[#D5E8F6] rounded-2xl p-5 md:p-6 flex flex-col justify-between md:h-[464px] group gap-3">
                    <div className='flex flex-col gap-4 md:gap-5'>
                        <p className="text-xs md:text-sm text-black leading-5 md:leading-[22px]">
                            Our tailored benchmarking platform ensure precise, apple-to-apple
                            comparisons for relevant assessments of risk and rewards.
                        </p>

                        <ul className="text-xs md:text-[14px] font-normal list-disc ml-4.5 md:ml-5 leading-5 md:leading-[22px]">
                            <li>
                ...
                <div className="w-1/2 max-[1199px]:w-full flex flex-col sm:flex-row gap-[25px] sm:h-[464px]">
                    ...
                    <div className="w-full sm:w-1/2 flex flex-col gap-[25px]">
                        {/* TOP */}
                        <div
                            className="bg-[#C5DFFF] rounded-2xl p-5 md:p-6 flex flex-col justify-between gap-2.5 md:gap-3.5 group cursor-pointer"
                        ...
                        {/* BOTTOM */}
                        <div
                            className="bg-[#D6F6FD] rounded-2xl p-5 md:p-6 flex flex-col justify-between gap-3 md:gap-4 group cursor-pointer"
                    ...
                    {/* RIGHT COLUMN */}
                    <div
                        className="w-full sm:w-1/2 bg-[#D8FDF2] rounded-2xl p-5 md:p-6 flex flex-col justify-between gap-3 sm:gap-2 group cursor-pointer"
