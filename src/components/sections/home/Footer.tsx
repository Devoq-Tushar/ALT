    ...
    return (
        <footer className="relative w-full bg-home-primary md:pt-20 md:pb-6 py-8">
            <div className="container max-w-[1200px]!">
                ...
                {/* Top Section */}
                <div
                    className="flex w-full flex-row gap-[155px] border-b border-white/10 pb-8 md:pb-12 max-[1366px]:gap-[74px] max-[1199px]:gap-[32px] max-[1199px]:justify-between max-[991px]:flex-col max-[991px]:mt-[60px] max-[767px]:mt-[0px]">

                    {/* Logo Section */}
                    <div
                        className="
              flex w-[296px] flex-col gap-5
              max-[991px]:w-full max-[991px]:gap-4
            "
                    >
                    ...
                    <div
                        ...
                        <ul
                            ...
                            <h3 className="text-base md:text-[18px] font-semibold text-white">Company</h3>
                        ...
                        <ul
                            className="
                flex flex-col gap-3 md:gap-4 list-none p-0 m-0 w-full max-w-40
                max-[991px]:w-[30%]
                max-[767px]:w-[30%] max-[767px]:border-white/25 max-[767px]:pt-0
              "
                        >
                            <h3 className="text-base md:text-[18px] font-semibold text-white">Services</h3>
                            <li className="flex flex-col gap-4">
                ...
                flex flex-col gap-3 md:gap-4 list-none p-0 m-0 w-full max-w-40
                max-[991px]:w-[30%]
                max-[767px]:w-[40%] max-[767px]:border-white/25 max-[767px]:pt-0
              "
                        >
                            <h3 className="text-base md:text-[18px] font-semibold text-white">Support</h3>
                        ...
                        <div className="flex flex-col text-white gap-5">
                            <div className="flex flex-col text-white">
                                <label className="text-base md:text-[18px] font-semibold text-white">Contact Us</label>
                            ...
                            <div className="flex flex-col text-white">
                                <label className="text-base md:text-[18px] font-semibold text-white">Visit Us</label>
                                <span className="mt-2 flex items-center gap-2 text-white">
                                    <img src="assets/icons/icn-home-footer-map.svg" alt="" />
                ...
                <div
                    className="
            flex flex-col items-center justify-center gap-3 pt-6 md:py-6 md:pb-0
