        ...
        <div id="contact-us" className="relative overflow-hidden">
            ...
            <div className="relative flex flex-col justify-center items-center gap-6 sm:gap-[50px] container w-full p-6 sm:py-[100px] sm:pt-0 rounded-2xl z-10">
                <div className="relative overflow-hidden box-border bg-bg-primary rounded-[20px] content-stretch flex flex-col gap-8 md:gap-12 lg:gap-[72px] items-center p-10 md:p-14 lg:p-[72px] w-full">
                    <div className="content-stretch flex flex-col gap-5 items-center relative text-center text-white w-full">
                        <p className="font-semibold leading-[1.3] relative text-[24px] md:text-[38px] lg:text-[48px] uppercase ">Let’s get <br className="block md:hidden" /> started with <br className="block md:hidden" /> ALT</p>
                        <p className="font-normal leading-normal relative text-[14px] md:text-[15px] lg:text-[16px] w-full max-w-[468px]">Join us and convert complex Information into compelling narratives with ease</p>
                    </div>

                    <button className="bg-[#1877f2] box-border flex gap-4 items-center justify-center px-6 py-[11.5px] md:px-[34px] md:py-[15px] relative rounded-[48px] w-fit transition-all duration-300 ease-out
